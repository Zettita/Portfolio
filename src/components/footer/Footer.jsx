  ...
  return (
    <footer id="contacto" className={styles.footer}>
      ...
      <ul className={styles.ul}>
        ...
        <li className={styles.li}><SiGmail className={styles.svg} /><a className={styles.a} href="mailto:uriel.solnik@gmail.com"> Gmail</a></li>
        <li className={styles.li}><SiGithub className={styles.svg} /><a className={styles.a} href="https://github.com/Zettita"> GitHub</a></li>
      </ul>
